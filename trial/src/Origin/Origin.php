 ...
 /**
   ...
   /**
        ...
        protected function __construct() {
			...
			if( $_SERVER["REQUEST_URI"]=="/~boer13/phpmvc/kmom07/triload/trial/my" ){$this->a='tre';}
			
			if( $_SERVER["REQUEST_URI"]=="/~boer13/phpmvc/kmom07/triload/trial/my/blog" ){$this->a='tre';}

			if( $_SERVER["REQUEST_URI"]=="/~boer13/phpmvc/kmom07/triload/trial/my/guestbook" ){$this->a='tre';}
